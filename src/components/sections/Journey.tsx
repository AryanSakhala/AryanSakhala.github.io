...
const experiences = [
  ...
  },
  {
    ...
    orgUrl: "https://vidyashilp.edu.in/",
    dept: "Research",
    status: "COMPLETED",
    desc: "Springer LNNS Publication | DS Teaching Assistant",
    descUrl: "https://www.researchgate.net/publication/399915120_A_Machine_Learning_Approach_to_Analyzing_the_Impact_of_Environmental_Social_and_Governance_ESG_Indicators_on_Financial_Performance",
        ...
        <div className="relative">
          ...
          <div className="space-y-6 lg:space-y-0">
            {experiences.map((exp, index) => {
              ...
              const statusColors = {
                STARTED: { bg: "var(--term-cyan)", text: "#000" },
                          ...
                          <p className="text-[var(--term-text-muted)] text-xs sm:text-sm break-words">
                            {exp.orgUrl ? (
                              <a
                                ...
                                className="hover:text-[var(--term-cyan)] transition-colors border-b border-transparent hover:border-[var(--term-cyan)]/50"
                              >
                                {exp.org}
                              </a>
                            ) : (
                            ...
                            {" "}
                            <span className="text-[var(--term-text-subtle)]">/ {exp.dept}</span>
                          </p>
                        </div>
                      </div>
